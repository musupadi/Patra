        ...
        getData.enqueue(new Callback<ResponseModel>() {
            ...
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                try {
                    ...
                    navUsername.setText(mItems.get(0).jabatan);
                    navName.setText(mItems.get(0).nama);
                    method.DecodeBase64(mItems.get(0).photo,navImage);
                }catch (Exception e){
                    Toast.makeText(MainActivity.this, "Token Expired", Toast.LENGTH_SHORT).show();
                    method.AutoLogout(MainActivity.this);
                }
            }
